                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-sm-4">
                                                ...
                                                <div class="modal-body">
                                                  <center>
                                                    <p>An AutoCad Competition that brings huge participation from all the colleges. It is a competition to see who draws the best drawing on the software in the stipulated amount of time. Even the best breaks down in this race of detailing and finishing.</p>
                                                  </center>
                                                  <hr> 
                                                  <p>
                                                  ...
                                                  <p>
                                                    In this round participants will solve a given problem statement under given time limit. This round will test their drafting speed and skills. The fastest and the finest fingers will be selected for the next round. 
                                                  </p>
                                                  <strong>Round 2:</strong>
                                                  <p>
                                                   In this round, participants will be given a problem statement according to which , they will have to plan and draft drawing within given time . This round will test their planning skills, level in time management and  creative skills. 
                                                 </p>
                                                 <p>
                                                  <div class = "row">
                                                    <div class="one_half">
                                                      ...
                                                      <ul>
                                                        <li>
                                                                1  One Participant per entry

                                                        </li>
                                                        <li>
                                                                  2 Computers  pre installed with AutoCAD 2015 will be provided. 
                                                        </li>
                                                        <li>
                                                                  3 Problem statements will be given at the time of the event
                                                        </li>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                              ...
                                              <div class="modal-body">
                                                ...
                                                <br>
                                                <a href="files/tendernotice.pdf" style="color:blue" download>
                                                      <strong>Click here to download tender notice. </strong> 
                                                </a>
                                                <br>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                              ...
                                              <div class="modal-body">
                                                ...
                                                <br>
                                                <a href="files/elucidation.pdf" style="color:blue" download>
                                                      <strong>Click here to download technical paper format. </strong> 
                                                </a>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-sm-4">
                                            ...
                                            <div class="modal-body">
                                              ...
                                              Design a flex ,displaying your innovative ideas towords the concept of smart city.
                                                <strong> <h5>Objective </h5> </strong>
                                              <ul> 
                                                <li>
                                                  1.poster or flex  is an art and visual  presentation which communicates your ideas to the viewers 
                                                  
                                                </li>

                                                <li>
                                                  2.provide a clear flow of information from introduction to conclusion 
                                                  body of flex (should include):
                                                  <ul>
                                                    <li>
                                                     1.title                       
                                                ...
                                                <li>
                                                  7.Result/conclusion/summary     
                                                </li>

                                                <li>
                                                 8.Tables/graph/charts  
                                               </li>
                                          ...
                                          <strong><h5>Design Your Flex</h5> </strong>
                                        <ul>
                                          <li>
                                            1.overall size: 4x2 ft.
                                          </li>
                                          <li>

                                            2.flex printing is required
                                          </li>
                                          <li>

                                            3.choose bright colours
                                          </li>
                                          <li>

                                            4.allocate a specific font/style/colour to subtitles to distinguish them clearly  from rest of the text

                                          </li>
                                          <li>
                                            5.font on flex should be clearly readable at least from distance of  5 ft.

                                          </li>
                                          <li>
                                            6.use statement ,photo ,diagram as a focal point of attraction 
                                          </li>
                                          <li>

                                            7.focus on the topic. do not try to include everything you know.
                                          </li>
                                          <li>
                                            8.text should be concise enough to be read in 8 min.
                                          </li>
                                          <li>
                                            9.text of the content should be large enough to be easily readable
                                          </li>

                                        </ul>
                                        
                                           <strong> <h5>Topic Criteria </h5> </strong>
                                        
                                        
                                        Innovative ideas,that can enhance the elements of the society ,modification to the old system and to give a subtitutes for the traditional elements for the betterment of concepts of "smart city"
                                        all the topics related to the criteria of "smart city" are eligible
                                            <strong><h5>Judging Criteria:</h5></strong>
                                        
                                        <ul>
                                              <li>
                                                      1.Relevance of the project idea
                                              </li>
                                              <li>
                                                      2.Selection of topic 
                                              </li>
                                              <li>
                                                      3.Ability to explain technical  topic clearly
                                              </li>
                                              <li> 
                                                      4.Poster organization & quality
                                              </li>
                                              <li> 
                                                      5.Effective presentation skills in the given time (max. 8 min.)
                                              </li>
                                        </ul>
                                              <strong><h5>Team: </h5></strong>
                                        
                                        A team should consist of maximum 3 members
                                      </div>
                                      <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                      </div>
